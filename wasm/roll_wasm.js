...
* @returns {string}
*/
export function roll_dice_short(s, advanced) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.roll_dice_short(retptr, ptr0, len0, advanced);
...
* @returns {any}
*/
export function roll_dice(s, advanced) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.roll_dice(retptr, ptr0, len0, advanced);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('roll_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
